...
document.body.style.background = "linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) , url('assets/img/" + randomBackground + "')";
...
cityInput.addEventListener("keyup", function(event)
{
  if(event.key === "Enter")
  {
		...
		function loader()
		{
			...
			img2.src = "img/loader.gif";
			img3.src = "img/loader.gif";
    ...
    var apiKey = "15ce300876b2db60cf3b4ce6beb7c63b"; // Default
    var unit = "metric";
