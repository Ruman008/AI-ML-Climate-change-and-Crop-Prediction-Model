 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              SIET CAMPUS, BIJAPUR<br>
		              Karnataka<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+916360100285"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+916360100285"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="zoya@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
       ...
       <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-instagram rounded-circle" data-toggle="tooltip" data-original-title="Follow us">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p>&copy; Copyright 2024 Crop Prediction With Climate Change, All rights reserved </p>
                </div>
           </div>
        </div>
    </footer>
