    ...
    >
      <div class="container-fluid">
        <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
          <li class="nav-item dropdown">
            <a href="iindex.php" class="navbar-brand mr-lg-5 text-white">
                               <img src="assets/img/agri.png" style="height: 150px;"/>
            </a>
          </li>
        </ul>
	 ...
	 <li class="nav-item" id="prediction">
      ...
      <a class="dropdown-item" href="Air_quality_analysis.php">Air Quality Analysis​</a>
      <a class="dropdown-item" href="Wheather_forecast.php">Wheather Forecasting​</a>
		  </div>
		</div>
			</li>
      ...
      <a class="dropdown-item" href="Temperature_prediction.php">Temperature Prediction​</a>
		  </div>
		</div>
			</li>
      ...
      <li class="nav-item" id="recommendation">
		  ...
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"
                  ><i class="text-white fas fa-gavel"></i> Forecasting</span
                >
		  </a>

		   <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			<a class="dropdown-item" href="wheather.php">Live Wheather</a>
			<a class="dropdown-item" href="fertilizer_recommendation.php">Fertilizer Recommendation​</a>
      <a class="dropdown-item" href="Temperature_prediction.php">Temperature Prediction​</a>
		  </div>
		  </div>
