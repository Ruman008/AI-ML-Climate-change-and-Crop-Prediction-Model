        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-7">
              <h1 class="text-white">CLIMACROP-NEXUS</h1>
              <p class="text-white">
               A Farmer's hope!
                ...
                <div class="card card-body bg-gradient-success">
                  <blockquote cite="blockquote">
                    <h6 class="mb-0 text-dark">
                      <em
                        ><b
                          > “Agriculture is our wisest pursuit because it will, in the end, contribute most to real wealth, good morals, and happiness.”  --Thomas Jefferson..”</b
                        ></em
                      >
                    </h6>
                    <br />
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Farmers can get recommendations for crop and fertilizer and even 
            predictions for crop, yield and rainfall.A thorough analysis of Climate factors connects it to climate change. All these are implemented using ML with proper dataset. </p>
          ...
          <div class="row align-items-center"> 
            <div class="col-lg-5 col-md-8 mr-auto text-left"> 
              <div class="pr-md-5"> 
                ...
                <p>The time is now for the next step in farming. We bring you the future of farming along with great tools for asisting the farmers in better decision making.</p>
                <ul class="list-unstyled mt-5"> 
                  ...
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">Air Quality Analysis</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">Wheather and Temperature Forecasting</h6>
                      </div>
                    </div>
                  </li>
                </ul>
